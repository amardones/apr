...
import cl.apr.facade.UsuarioFacade;
...
/*<h:form id="frmLogin">
                    <p:growl id="mensageGeneral" showDetail="true" sticky="false"/>
                    <h:panelGrid columns="2">
                        <p:outputLabel value="Correo electrónico" for="mail"/>
                        <p:inputText id="mail" size="40" value="#{UsuarioController.mail}"/>
                        <p:outputLabel value="password" for="password"/>
                        <p:password id="password" size="40" value="#{UsuarioController.password}"/>
                        <h:panelGroup>
                            
                        </h:panelGroup>
                        <p:commandButton value="Ingresar" ajax="false" action="#{UsuarioController.login()}"/>
                        </h:form>

<div id="divSesionUsuario">
                            <span>
                                <b>Sesión iniciada por: </b>
                                <p:outputLabel value="#{UsuarioController.mail==null ? 'Anónimo' : UsuarioController.mail}"/>
                            </span>
                            <p:commandButton value="Cerrar sesión" action="#{UsuarioController.cerrarSesion()}"/>
                 </div>
*/