...
import cl.apr.controller.RegistroEstadoController;
...
import cl.apr.pdf.ReporteRegistroPDF;
 ...
 * @author hmardones
 */
@WebServlet(name = "verReporteRegistro", urlPatterns = {"/verReporteRegistro"})
public class verReporteRegistroPDF extends HttpServlet {

    @Inject
    private RegistroEstadoController reportesRegistro;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)  throws ServletException, IOException {
       String mensajeError = "SE PRODUJO UN ERROR AL INTENTAR DESCARGAR VISTA DE REGISTRO EN PDF.";
        try{
                ...
                List<RegistroEstado> list = reportesRegistro.getItems();
                
                baos =  ReporteRegistroPDF.crearPdf(list);
