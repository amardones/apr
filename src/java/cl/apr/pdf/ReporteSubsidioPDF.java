...
public class ReporteSubsidioPDF {
	...
	static public ByteArrayOutputStream crearPdf(List<SubsidioReporte> list,int total){
		...
		try {			
                        ...
                        tablaTitulo.addCell(new Phrase("Reporte Subsidios",UtilPDF.fTitulo1));
                        tablaTitulo.addCell(new Phrase(" ",UtilPDF.fTitulo1));
                        
                        PdfPTable tabla   = new PdfPTable(5);
                        tabla.setWidthPercentage(100);
                        tabla.setWidths(new float[] {20f, 35f, 15f, 15f,15f}); 
                        ...
                        PdfPCell  c = new PdfPCell(new Phrase("Periodo",UtilPDF.fCuerpoTablaBold));
                        ...
                        c = new PdfPCell(new Phrase("Cuenta",UtilPDF.fCuerpoTablaBold));
                        c.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        c.setHorizontalAlignment(Element.ALIGN_CENTER); 
                        c.setBorder(Rectangle.BOX);
                        c.setBackgroundColor(UtilPDF.borderColor);
                        ...
                        c = new PdfPCell(new Phrase("Subsidio",UtilPDF.fCuerpoTablaBold));
                        c.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        c.setHorizontalAlignment(Element.ALIGN_CENTER); 
                        c.setBorder(Rectangle.BOX);
                        c.setBackgroundColor(UtilPDF.borderColor);
                        ...
                        tabla.addCell(c);
                         ...
                         c = new PdfPCell(new Phrase("Valor Subsidiado",UtilPDF.fCuerpoTablaBold));
                        c.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        c.setHorizontalAlignment(Element.ALIGN_CENTER); 
                        c.setBorder(Rectangle.BOX);
                        c.setBackgroundColor(UtilPDF.borderColor);
                        ...
                        for(int i=0;i<list.size();i++){
                            av=list.get(i);
                            tabla.addCell(new Phrase(av.getIdPeriodo(),UtilPDF.fCuerpoTabla));
                            tabla.addCell(new Phrase(av.getIdcuenta(),UtilPDF.fCuerpoTabla));
                            tabla.addCell(new Phrase(av.getFechaCreacion(),UtilPDF.fCuerpoTabla));
                            tabla.addCell(new Phrase(av.getSubsidio(),UtilPDF.fCuerpoTabla));
                            tabla.addCell(new Phrase(""+NumeroFormato.formatearNumeroPesos(av.getDescuento_periodo()),UtilPDF.fCuerpoTabla));
                        ...
                        tabla.addCell(new Phrase(""+NumeroFormato.formatearNumeroPesos(total),UtilPDF.fCuerpoTablaBold));
