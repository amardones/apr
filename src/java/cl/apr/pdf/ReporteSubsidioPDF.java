...
public class ReporteSubsidioPDF {
	...
	static public ByteArrayOutputStream crearPdf(List<SubsidioReporte> list,int total){
		...
		try {			
                        ...
                        PdfPCell  c = new PdfPCell(new Phrase("Periodo",fCuerpoTablaBold));
                        ...
                        c = new PdfPCell(new Phrase("Cuenta",fCuerpoTablaBold));
                        c.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        c.setHorizontalAlignment(Element.ALIGN_CENTER); 
                        c.setBorder(Rectangle.BOX);
                        c.setBackgroundColor(borderColor);
	 ...
	 static private PdfPCell crearAvisos(AvisoCobro aviso, List<BarChartItem> barChartItem) {
            ...
            try {
                ...
                Logger.getLogger(ReporteSubsidioPDF.class.getName()).log(Level.SEVERE, null, ex);
            }
